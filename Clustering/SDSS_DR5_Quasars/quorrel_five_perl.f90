...
!!   2 S L A Q 
!!
open(1,file='3yr_obj_v4_Sample8_nota01ao2s01_radecz.cat')
!!open(1,file='../data/DR5QSO_uni_data_wFibre_v2.dat')
open(2,file='rand_LRG_Sm8_spe.dat')

!!
!!   S D S S     D R 5     Q U A S A R S
!!
!open(1,file='../data/DR5QSO_uni_data.dat')
!!open(1,file='../data/DR5QSO_uni_data_wFibre_v2.dat')
...
! O/P FILES
open( 9,file='k_output_2SLAQ_LRGs_temp.dat')
open(10,file='k_output_lin_2SLAQ_LRGs_temp.dat')
open(18,file='k2d_output_2SLAQ_LRGs_temp.dat')
open(27,file='K_wp_output_2SLAQ_LRGs_temp.dat')
!
open(44,file='z_values_2SLAQ_LRGs_temp.dat')
open(55,file='ra_dec_z_2SLAQ_LRGs_temp_used.dat')
open(56,file='ra_dec_z_2SLAQ_randoms_used_temp.dat')
!
